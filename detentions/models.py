...
class PrisonStation(IdProvider):
    ...
    name = models.CharField(
        max_length=200,
        help_text="The designation of the prison station",
    ...
    part_of = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        verbose_name="übergeordnetes Lager",
    )
    ...
    def get_absolute_url(self):
        return reverse("detentions:prisonstation_detail", kwargs={"pk": self.id})
...
class PersonPrison(IdProvider):
    ...
    def get_absolute_url(self):
        return reverse("detentions:personprison_detail", kwargs={"pk": self.id})
