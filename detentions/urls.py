...
urlpatterns = [
    ...
    url(r'^personprison/detail/(?P<pk>[0-9]+)$', views.PersonPrisonDetailView.as_view(),
        name='personprison_detail'),
    url(r'^personprison/create/$', views.PersonPrisonCreate.as_view(),
        name='personprison_create'),
    url(r'^personprison/edit/(?P<pk>[0-9]+)$', views.PersonPrisonUpdate.as_view(),
        name='personprison_edit'),
    url(r'^personprison/delete/(?P<pk>[0-9]+)$', views.PersonPrisonDelete.as_view(),
