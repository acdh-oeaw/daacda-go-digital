...
class OnlineRessource(IdProvider):
    ...
    description_short = models.CharField(
        max_length=250,
        blank=True,
        help_text="A short description of the online resource",
    ...
    related_persons = models.ManyToManyField(
        ...
        help_text="Persons related to this online resource",
        related_name="URLperson",
    )
    related_bombers = models.ManyToManyField(
        ...
        help_text="Bombers related to this online resource",
        related_name="URLbomber",
    )
    ...
    def get_absolute_url(self):
        return reverse("entities:onlineressource_detail", kwargs={"pk": self.id})
...
class Place(IdProvider):
    ...
    geonames_id = models.CharField(
        max_length=50, blank=True, help_text="GND-ID for the place"
    )
    lat = models.DecimalField(
        ...
        blank=True,
        null=True,
        help_text="The latitude of the place",
    )
    ...
    place_type = models.CharField(
        ...
        blank=True,
        max_length=50,
        help_text="The type of the place",
    )
...
class Bomber(models.Model):
    ...
    plane_id = models.CharField(
        max_length=50,
        blank=True,
        verbose_name="Flugzeugnr.",
        help_text="The plane ID",
    )
    name = models.CharField(
        max_length=250,
        blank=True,
        verbose_name="Flugzeugname",
        help_text="The name of the plane",
    )
    ...
    target_place = models.ForeignKey(
        ...
        help_text="The place the bomber targeted",
    )
    ...
    comment = models.TextField(
        blank=True, verbose_name="Kommentar", help_text="Space for a comment"
    )
    related_urls = models.ManyToManyField(
        OnlineRessource,
        max_length=250,
    ...
    uhrzeit = models.CharField(
        max_length=250, blank=True, verbose_name="Uhrzeit", help_text="Time of the day"
    )
    ...
    anmerkung = models.TextField(
        blank=True, verbose_name="Anmerkung (Spalte Y)", help_text="A comment"
    )
    ...
    @cached_property
    def get_orgs(self):
        rel_items = Institution.objects.filter(Q(has_bomber=self))
        return rel_items
            ...
            geojson = {
                ...
                "properties": {
                    ...
                    "label": "{}: Crashplace of Bomber {}".format(
                        self.crash_place.name, self.macr_nr
                    ),
                    "geonames_id": getattr(self, "geonames_id", "NONE"),
                    "self_link": self.get_absolute_url(),
                },
                    ...
                    "features": [
                        {
                            ...
                            "properties": {
                                "name": "{} (Place of target)".format(
                                    self.target_place.name
                                ),
...
class Person(IdProvider):
    ...
    dog_tag = models.CharField(
        max_length=300,
        blank=True,
        verbose_name="Kennnummer",
        help_text="The number identifying the person",
    )
    written_name = models.CharField(
        max_length=300,
        blank=True,
        verbose_name="Name Kontrolle",
    ...
    def get_stations(self):
        stations = (
            self.get_prisonstations()
            .exclude(relation_type=None)
...
TRIED = (("tried", "tried"), ("not tried", "not tried"))
...
class PersonWarCrimeCase(IdProvider):
    ...
    related_person = models.ForeignKey(
        ...
        related_name="has_related_warcase",
        null=True,
        on_delete=models.SET_NULL,
    )
...
class Airstrike(IdProvider):
    ...
    target = models.ForeignKey(
        ...
        help_text="Place targeted by the airstrike",
        on_delete=models.SET_NULL,
    ...
    number_of_planes = models.IntegerField(
        blank=True,
        null=True,
        verbose_name="Number of Planes",
        help_text="Estimated number of\
    ...
    airforce = models.ForeignKey(
        ...
        help_text="Name of the Airforce involved in the attack",
        on_delete=models.SET_NULL,
        ...
        if self.target.lng:
            ...
            geojson = {
                ...
                "properties": {
                    ...
                    "label": "{}: attacked on {}".format(self.target.name, json_date),
                    "geonames_id": getattr(self, "geonames_id", "NONE"),
                    "self_link": self.get_absolute_url(),
                },
            }
