...
urlpatterns = [
    url(
        r"^altnames/$", views.AlternativeNameListView.as_view(), name="browse_altnames"
    ),
    url(
    ...
    url(
        r"^bomber-timestamps/$", netviz_views.bomber_time_json, name="bomber_time_json"
    ),
    url(
        r"^bombers/detail/(?P<pk>[0-9]+)$",
        views.BomberDetailView.as_view(),
        name="bomber_detail",
    ),
    url(r"^bomber/create/$", views.BomberCreate.as_view(), name="bomber_create"),
    url(
        r"^bomber/edit/(?P<pk>[0-9]+)$",
        views.BomberUpdate.as_view(),
        name="bomber_edit",
    ),
    url(
        r"^bomber/delete/(?P<pk>[0-9]+)$",
    ...
    url(
        r"airstrike/detail/(?P<pk>[0-9]+)$",
        views.AirstrikeDetailView.as_view(),
        name="airstrike_detail",
    ),
    url(
        r"airstrike/create/$", views.AirstrikeCreate.as_view(), name="airstrike_create"
    ),
    url(
        r"airstrike/edit/(?P<pk>[0-9]+)$",
        views.AirstrikeUpdate.as_view(),
        name="airstrike_edit",
    ),
    url(
        r"airstrike/delete/(?P<pk>[0-9]+)$",
