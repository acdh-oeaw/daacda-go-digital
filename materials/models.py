...
class Gedenkzeichen(models.Model):
    ...
    name = models.CharField(
        max_length=250, blank=True, help_text="Name des Gedenkzeichens"
    )
    ...
    def get_absolute_url(self):
        return reverse("materials:gedenkzeichen_detail", kwargs={"pk": self.id})
...
class UserContribution(models.Model):
    ...
    content_checked_by = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="content_checked_by_user",
    ...
    related_persons = models.ManyToManyField(
        ...
        related_name="usercontribution_person",
    )
    related_bombers = models.ManyToManyField(
        ...
        related_name="usercontribution_bomber",
    )
    ...
    def get_absolute_url(self):
        return reverse("materials:usercontribution_detail", kwargs={"pk": self.id})
